...
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  \node[state] (s) {$s$};
	  \node[state] (v2) [right = 3cm of s] {$v_2$};
	  \node[state] (v1) [above = of v2] {$v_1$};
	  \node[state] (v3) [below = of v2] {$v_3$};
	  \node[state] (t) [right = 3cm of v2] {$t$};
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge node {$0/\infty$}	(v1)
			(s)	edge [bend left=15] node {$0/1$}	(v2)
			(s)	edge node[swap] {$0/3$}	(v3)
			
			(v1)	edge node {$0/3$}	(t)
			(v2)	edge [bend left=15] node {$0/3$}	(t)
			(v3)	edge node {$0/1$}	(t)
			
			(v1)	edge[bend left=10] node {$0/1$}	(v2)
			(v2)	edge[bend left=10] node {$0/4$}	(v1)
			
			(v1)	edge[bend left=30] node {$0/1$}	(v3)
			(v3)	edge[bend left=30] node {$0/\infty$}	(v1)
...
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge[bend left=10] node {$\infty$}	(v1)
%			(v1)edge[bend left=10] node {$0$}	(s)
			
			(s)	edge [bend left=15] node {$1$}	(v2)
%			(v2)edge [bend left=15] node {$0$}	(s)
			
			(s)	edge[color=red,bend right=10] node[swap] {$3$}	(v3)
%			(v3)edge[bend right=10] node[swap] {$0$}	(s)
			
			(v1)edge[color=red,bend left=10] node {$3$}	(t)
%			(t)	edge[bend left=10] node {$0$}	(v1)
			
			(v2)edge [bend left=15] node {$3$}	(t)
%			(t)	edge [bend left=15] node {$0$}	(v2)
			
			(v3)edge[bend left=10] node {$1$}	(t)
%			(t)	edge[bend left=10] node {$0$}	(v3)
			
			(v1)	edge[bend left=10] node {$1$}	(v2)
			(v2)	edge[bend left=10] node {$4$}	(v1)
			
			(v1)	edge[bend left=30] node {$1$}	(v3)
			(v3)	edge[color=red,bend left=30] node {$\infty$}	(v1)
			
			(v3)	edge[bend left=10] node {$1$}	(v2)
%			(v2)	edge[bend left=10] node {$0$}	(v3)
...
\item $2$-я итерация алгоритма. $M$~--- величина увеличивающего пути:\newline
\begin{tabular}{lcll}
Сеть и поток&  & Остаточная сеть & $M$\\
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			...
			(v1)	edge[bend left=30] node {$0/1$}	(v3)
			(v3)	edge[bend left=30] node {$3/\infty$}	(v1)
...
%			(v1)edge[bend left=10] node {$0$}	(s)
			...
			(s)	edge [color=red,bend left=15] node {$1$}	(v2)
%			(v2)edge [bend left=15] node {$0$}	(s)
			
%			(s)	edge[bend right=10] node[swap] {$0$}	(v3)
			(v3)edge[bend right=10] node[swap] {$3$}	(s)
			
%			(v1)edge[bend left=10] node {$0$}	(t)
			(t)	edge[bend left=10] node {$3$}	(v1)
			
			(v2)edge [color=red,bend left=15] node {$3$}	(t)
%			(t)	edge [bend left=15] node {$0$}	(v2)
...
%			(t)	edge[bend left=10] node {$0$}	(v3)
			...
			(v1)	edge[bend left=30] node {$4$}	(v3)
			(v3)	edge[bend left=30] node {$\infty$}	(v1)
...
\item $3$-я итерация алгоритма. $M$~--- величина увеличивающего пути:\newline
\begin{tabular}{lcll}
Сеть и поток&  & Остаточная сеть & $M$\\
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge node {$0/\infty$}	(v1)
			(s)	edge [bend left=15] node {$1/1$}	(v2)
			(s)	edge node[swap] {$3/3$}	(v3)
			
			(v1)	edge node {$3/3$}	(t)
			(v2)	edge [bend left=15] node {$1/3$}	(t)
			(v3)	edge node {$0/1$}	(t)
...
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge[color=red,bend left=10] node {$\infty$}	(v1)
%			(v1)edge[bend left=10] node {$0$}	(s)
			
%			(s)	edge [color=red,bend left=15] node {$0$}	(v2)
			(v2)edge [bend left=15] node {$1$}	(s)
...
%			(v1)edge[bend left=10] node {$0$}	(t)
			...
			(v2)edge [color=red,bend left=15] node {$2$}	(t)
			(t)	edge [bend left=15] node {$1$}	(v2)
			
			(v3)edge[bend left=10] node {$1$}	(t)
%			(t)	edge[bend left=10] node {$0$}	(v3)
			
			(v1)	edge[color=red,bend left=10] node {$1$}	(v2)
			(v2)	edge[bend left=10] node {$4$}	(v1)
...
\item $4$-я итерация алгоритма. $M$~--- величина увеличивающего пути:\newline
\begin{tabular}{lcll}
Сеть и поток&  & Остаточная сеть & $M$\\
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge node {$1/\infty$}	(v1)
			(s)	edge [bend left=15] node {$1/1$}	(v2)
			(s)	edge node[swap] {$3/3$}	(v3)
			
			(v1)	edge node {$3/3$}	(t)
			(v2)	edge [bend left=15] node {$2/3$}	(t)
			(v3)	edge node {$0/1$}	(t)
			
			(v1)	edge[bend left=10] node {$1/1$}	(v2)
			(v2)	edge[bend left=10] node {$0/4$}	(v1)
...
%			(v1)edge[bend left=10] node {$0$}	(t)
			...
			(v2)edge [bend left=15] node {$1$}	(t)
			(t)	edge [bend left=15] node {$2$}	(v2)
			
			(v3)edge[color=red,bend left=10] node {$1$}	(t)
%			(t)	edge[bend left=10] node {$0$}	(v3)
			
%			(v1)	edge[color=red,bend left=10] node {$0$}	(v2)
			(v2)	edge[bend left=10] node {$5$}	(v1)
			
			(v1)	edge[color=red,bend left=30] node {$4$}	(v3)
			(v3)	edge[bend left=30] node {$\infty$}	(v1)
...
\item $5$-я итерация алгоритма. $M$~--- величина увеличивающего пути:\newline
\begin{tabular}{lcll}
Сеть и поток&  & Остаточная сеть & $M$\\
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			...
			(v1)	edge[bend left=30] node {$1/1$}	(v3)
			(v3)	edge[bend left=30] node {$3/\infty$}	(v1)
...
%			(v1)edge[bend left=10] node {$0$}	(t)
			...
			(v2)edge [color=red,bend left=15] node {$1$}	(t)
			(t)	edge [bend left=15] node {$2$}	(v2)
			
%			(v3)edge[color=red,bend left=10] node {$0$}	(t)
			(t)	edge[bend left=10] node {$1$}	(v3)
			
%			(v1)	edge[color=red,bend left=10] node {$0$}	(v2)
			(v2)	edge[bend left=10] node {$5$}	(v1)
			
			(v1)	edge[color=red,bend left=30] node {$3$}	(v3)
			(v3)	edge[bend left=30] node {$\infty$}	(v1)
			
			(v3)	edge[color=red,bend left=10] node {$1$}	(v2)
%			(v2)	edge[bend left=10] node {$0$}	(v3)
...
\item $6$-я итерация алгоритма. $M$~--- величина увеличивающего пути:\newline
\begin{tabular}{lcll}
Сеть и поток&  & Остаточная сеть & $M$\\
\begin{minipage}{0.35\textwidth}
\begin{tikzpicture}[shorten >=1pt,node distance=2cm,on grid,auto,initial text=]
 \tikzstyle{every node}=[font=\small]
	  ...
	  \begin{scope}[every node/.style={scale=.5}]
  	  \path[->] 
			(s)	edge node {$3/\infty$}	(v1)
			(s)	edge [bend left=15] node {$1/1$}	(v2)
			(s)	edge node[swap] {$3/3$}	(v3)
			
			(v1)	edge node {$3/3$}	(t)
			(v2)	edge [bend left=15] node {$3/3$}	(t)
			(v3)	edge node {$1/1$}	(t)
			...
			(v1)	edge[bend left=30] node {$1/1$}	(v3)
			(v3)	edge[bend left=30] node {$2/\infty$}	(v1)
...
%			(v2)edge [color=red,bend left=15] node {$0$}	(t)
			(t)	edge [bend left=15] node {$3$}	(v2)
...
%			(v1)	edge[color=red,bend left=10] node {$0$}	(v2)
			...
			(v1)	edge[bend left=30] node {$2$}	(v3)
			(v3)	edge[bend left=30] node {$\infty$}	(v1)
			
%			(v3)	edge[bend left=10] node {$0$}	(v2)
			(v2)	edge[bend left=10] node {$1$}	(v3)
...
\end{minipage}& 1\\
\end{tabular}
Зеленые~--- достижимые из $s$. $t$ недостижима, поэтому алгоритм останавливается.
\item Получаем минимальный разрез $S=\{s,v_1,v_3\}$, $T=\{t,v_2\}$, откуда $A=\{1,3\}$, $B=\{2\}$~--- на $I$ и $II$ процессорах соответственно. Значение функции равно минимальному разрезу $=$ максимальному потоку, равно $c(S,T)=|f|=7$. Проверим: $\alpha_1+\alpha_3+\beta_2+\gamma_{12}+\gamma{32}=3+1+1+1+1=7\,\blacksquare$
\end{enumerate}
\end{document}