...
\item $X=W|Z$, $W,W\in\REG$. Тогда $\varphi(X)\equiv\varphi(W|Z)\equiv\varphi(W)|\varphi(Z)$. Аналогично $R_3(W),R_3(Z)\leqslant n\overset{P(n)}{\Rightarrow}\varphi(W),\varphi(Z)\in\REG\Rightarrow\varphi(X)=\varphi(W)|\varphi(Z)\in\REG$.
\end{enumerate}
\end{enumerate}
\end{document}