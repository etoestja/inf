...
Машина Карно обладает наибольшим КПД, но ее мощность равна нулю. Действительно, тепло получается и отдается на изотермах, что означает равенство температуры рабочего тела во время теплообмена температуре резервуара. Следовательно, поток тепла нулевой, значит, время прохождения изотермы бесконечно. Так как работа машины Карно конечна, получаем нулевую мощность:
$$N^{\text{Карно}}=0$$
% картинка %
\section{Решение}
Найдем тепловую машину с максимальной мощностью.
\subsection{Необходимые условия}
Необходимым условием является разность температур между резервуаром и рабочим телом (иначе $N=0$).\newline
...
\frac{\varkappa S(T_{\text{н}}-T_{\text{х}})^2}{LT_{\text{н}}}\frac{1-x-y}{y+\beta x}xy,
\begin{array}{lcr}
x=\frac{\Delta T_{\text{н}}}{T_{\text{н}}-T_{\text{х}}},\\
...
$\eta=1-\frac{T_2}{T_1}=1-\sqrt{\frac{T_{\text{х}}}{T_{\text{н}}}}$,\newline
