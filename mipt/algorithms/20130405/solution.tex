...
0 & 500 & 0 & 700 & 10500
\end{array}
\matrixr$, $\underline{y}^T\underline{b}=281000$. Заметим, что решения совпадают. Если назвать то, что соответствует строкам $A$ ресурсами (т.е. количество м$^3$ в самолете, суммарный вес, количества товаров), то двойственная задача имеет следующую интерпретацию:\newline
